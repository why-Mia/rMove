<nav x-data="{ open: false }" class="bg-white dark:bg-main-800 dark:border-gray-500 border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class=" flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-main-600 dark:hover:text-gray-300 dark:focus:bg-main-600 dark:focus:text-gray-300 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden dark:bg-main-650">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-main-600">
            <div class="px-4">
